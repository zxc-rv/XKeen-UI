...
export type AppAction =
  ...
  | { type: 'SET_CORE_INFO'; currentCore: string; coreVersions: { xray: string; mihomo: string }; availableCores: string[] }
  ...
  | { type: 'SHOW_MODAL'; modal: keyof Pick<AppState, 'showDirtyModal' | 'showCoreManageModal' | 'showUpdateModal' | 'showImportModal' | 'showTemplateModal' | 'showSettingsModal' | 'showCommentsWarningModal' | 'showGeoScanModal'>; show: boolean }

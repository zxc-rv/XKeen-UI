...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        "focus:bg-[var(--menu-active-bg)] data-highlighted:bg-[var(--menu-active-bg)] data-[variant=destructive]:text-destructive data-[variant=destructive]:focus:bg-[var(--menu-destructive-active-bg)] data-[variant=destructive]:*:[svg]:text-destructive data-[variant=destructive]:focus:text-destructive group/dropdown-menu-item relative flex items-center gap-2 rounded-sm px-1.5 py-1.25 text-sm outline-hidden select-none focus:font-semibold focus:text-[#60a5fa] not-data-[variant=destructive]:focus:**:text-[#60a5fa] data-disabled:pointer-events-none data-disabled:opacity-50 data-highlighted:font-semibold data-highlighted:text-[#60a5fa] not-data-[variant=destructive]:data-highlighted:**:text-[#60a5fa] data-inset:pl-8 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    />

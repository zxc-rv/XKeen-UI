...
function ComboboxTrigger({ className, children, ...props }: ComboboxPrimitive.Trigger.Props) {
  ...
  return (
    <ComboboxPrimitive.Trigger
      ...
      className={cn('[&_svg:not([class*=size-])]:size-4', open ? 'cursor-default!' : 'cursor-pointer!', className)}
      {...props}
    >
      {children}
...
function ComboboxInput({
  ...
  return (
    <InputGroup
      className={cn('w-auto', open && 'hover:bg-input-background!', className)}
      style={
        open
          ? {
      ...
      <InputGroupAddon align="inline-end">
        {showTrigger && (
          <InputGroupButton
            ...
            className={cn(
              'cursor-pointer! bg-transparent! group-has-data-[slot=combobox-clear]/input-group:hidden hover:bg-transparent! hover:text-inherit! data-pressed:bg-transparent dark:hover:bg-transparent!'
            )}
            disabled={disabled}
          >
            <ComboboxTrigger />
...
function ComboboxItem({ className, children, ...props }: ComboboxPrimitive.Item.Props) {
  return (
    <ComboboxPrimitive.Item
      ...
      className={cn(
        'focus:bg-accent data-highlighted:bg-accent relative flex w-full cursor-pointer items-center gap-2 rounded-sm py-1.25 pr-8 pl-1.5 text-sm outline-hidden select-none focus:font-semibold focus:text-[#60a5fa] not-data-[variant=destructive]:focus:**:text-[#60a5fa] data-disabled:pointer-events-none data-disabled:opacity-50 data-highlighted:font-semibold data-highlighted:text-[#60a5fa] not-data-[variant=destructive]:data-highlighted:**:text-[#60a5fa] [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*=size-])]:size-4',
        className
      )}
      {...props}
    >

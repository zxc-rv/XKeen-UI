...
export function GuiLog({ editorRef, configs, activeConfigIndex }: Props) {
  ...
  const [cfg, setCfg] = useState<LogConfig>(() => {
    ...
    return parseLogConfig(content) ?? { access: "", error: "", loglevel: "warning", dnsLog: false }
  })
        ...
        <div className="px-2">
          ...
          <div className="relative h-8 flex items-center">
            ...
            <div
              ...
              style={{ width: `${(levelIndex / (LOG_LEVELS.length - 1)) * 100}%`, background: color }}
            />
            {/* Dots */}
            {LOG_LEVELS.map((l, i) => {

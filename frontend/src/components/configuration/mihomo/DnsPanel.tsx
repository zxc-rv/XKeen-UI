          ...
          <Card>
            ...
            <CardContent className="flex flex-col gap-4">
              ...
              {config.enhancedMode === 'fake-ip' && (
                <>
                  ...
                  <div className="grid gap-2">
                    ...
                    />
                    <p className="text-muted-foreground text-[11px]">По одному на строку</p>
                  </div>
                </>
              )}
              ...
              <div className="grid gap-2">
                ...
                />
                <p className="text-muted-foreground text-[11px]">Ключ с двоеточием, затем значения через пробел</p>
              </div>

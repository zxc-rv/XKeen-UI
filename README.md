...
<sub> *На определенных mips/mipsle моделях может не работать некоторый функционал, также могут быть ошибки при запуске, при возникновении таковых создайте Issue с указанием названия модели, версии Keenetic OS и вывода команды `xkeen-ui -v` </sub>
